...
def alter_note(alter_note: Dict, config: Dict):
    ...
    note_path = path.join(config["notes_location"], "{}.{}".format(alter_note.alter, "md"))
...
def delete_note(rm_note: Dict, config: Dict):
    ...
    note_path = path.join(config["notes_location"], "{}.{}".format(rm_note.delete, "md"))
...
def parse_args() -> Dict:
    ...
    arguments.add_argument("-a", "--alter", dest="alter", type=str, help="Add/Edit note")
    arguments.add_argument("-d", "--delete", dest="delete", type=str, help="Delete note")
    arguments.add_argument("-l", "--list", dest="list", action='store_true', help="list notes")
